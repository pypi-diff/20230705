# Comparing `tmp/fbgemm_gpu_nightly_cpu-2023.7.4-cp39-cp39-manylinux2014_x86_64.whl.zip` & `tmp/fbgemm_gpu_nightly_cpu-2023.7.5-cp39-cp39-manylinux2014_x86_64.whl.zip`

## zipinfo {}

```diff
@@ -1,43 +1,43 @@
-Zip file size: 3198121 bytes, number of entries: 41
--rw-r--r--  2.0 unx      567 b- defN 23-Jul-04 13:02 fbgemm_gpu/__init__.py
--rw-r--r--  2.0 unx    14920 b- defN 23-Jul-04 13:02 fbgemm_gpu/_fbgemm_gpu_docs.py
--rw-r--r--  2.0 unx     2747 b- defN 23-Jul-04 13:02 fbgemm_gpu/batched_unary_embeddings_ops.py
--rw-r--r--  2.0 unx      818 b- defN 23-Jul-04 13:02 fbgemm_gpu/enums.py
--rwxr-xr-x  2.0 unx 10709064 b- defN 23-Jul-04 13:02 fbgemm_gpu/fbgemm_gpu_py.so
--rw-r--r--  2.0 unx     5648 b- defN 23-Jul-04 13:02 fbgemm_gpu/metrics.py
--rw-r--r--  2.0 unx     2339 b- defN 23-Jul-04 13:02 fbgemm_gpu/permute_pooled_embedding_modules.py
--rw-r--r--  2.0 unx     2737 b- defN 23-Jul-04 13:02 fbgemm_gpu/permute_pooled_embedding_modules_split.py
--rw-r--r--  2.0 unx     7682 b- defN 23-Jul-04 13:02 fbgemm_gpu/quantize_comm.py
--rw-r--r--  2.0 unx     4005 b- defN 23-Jul-04 13:02 fbgemm_gpu/quantize_utils.py
--rw-r--r--  2.0 unx     5745 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_embedding_configs.py
--rw-r--r--  2.0 unx     6661 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_embedding_inference_converter.py
--rw-r--r--  2.0 unx      525 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_embedding_optimizer_ops.py
--rw-r--r--  2.0 unx    19751 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_embedding_utils.py
--rw-r--r--  2.0 unx     2170 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_table_batched_embeddings_ops.py
--rw-r--r--  2.0 unx     3433 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_table_batched_embeddings_ops_common.py
--rw-r--r--  2.0 unx    61087 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_table_batched_embeddings_ops_inference.py
--rw-r--r--  2.0 unx    80868 b- defN 23-Jul-04 13:02 fbgemm_gpu/split_table_batched_embeddings_ops_training.py
--rw-r--r--  2.0 unx    39550 b- defN 23-Jul-04 13:02 fbgemm_gpu/ssd_split_table_batched_embeddings_ops.py
--rw-r--r--  2.0 unx      910 b- defN 23-Jul-04 13:02 fbgemm_gpu/uvm.py
--rw-r--r--  2.0 unx     1603 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/__init__.py
--rw-r--r--  2.0 unx     4717 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_adagrad.py
--rw-r--r--  2.0 unx     3354 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_adam.py
--rw-r--r--  2.0 unx     3112 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_approx_rowwise_adagrad_with_weight_decay.py
--rw-r--r--  2.0 unx     1906 b- defN 23-Jul-04 12:56 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_args.py
--rw-r--r--  2.0 unx     3354 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_lamb.py
--rw-r--r--  2.0 unx     3062 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_lars_sgd.py
--rw-r--r--  2.0 unx     2617 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_none.py
--rw-r--r--  2.0 unx     3370 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_partial_rowwise_adam.py
--rw-r--r--  2.0 unx     3370 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_partial_rowwise_lamb.py
--rw-r--r--  2.0 unx     5005 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_rowwise_adagrad.py
--rw-r--r--  2.0 unx     7014 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_rowwise_adagrad_with_counter.py
--rw-r--r--  2.0 unx     3105 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_rowwise_adagrad_with_weight_decay.py
--rw-r--r--  2.0 unx     4961 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_rowwise_weighted_adagrad.py
--rw-r--r--  2.0 unx     4250 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_codegen_lookup_invokers/lookup_sgd.py
--rw-r--r--  2.0 unx      635 b- defN 23-Jul-04 12:56 fbgemm_gpu/split_embedding_optimizer_codegen/optimizer_args.py
--rw-r--r--  2.0 unx     6136 b- defN 23-Jul-04 13:00 fbgemm_gpu/split_embedding_optimizer_codegen/split_embedding_optimizer_rowwise_adagrad.py
--rw-r--r--  2.0 unx     2933 b- defN 23-Jul-04 13:02 fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/METADATA
--rw-r--r--  2.0 unx      105 b- defN 23-Jul-04 13:02 fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/WHEEL
--rw-r--r--  2.0 unx       11 b- defN 23-Jul-04 13:02 fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx     4530 b- defN 23-Jul-04 13:02 fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/RECORD
-41 files, 11040377 bytes uncompressed, 3190491 bytes compressed:  71.1%
...
-Filename: fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/METADATA
+Filename: fbgemm_gpu_nightly_cpu-2023.7.5.dist-info/METADATA
 Comment: 
 
-Filename: fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/WHEEL
+Filename: fbgemm_gpu_nightly_cpu-2023.7.5.dist-info/WHEEL
 Comment: 
 
-Filename: fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/top_level.txt
+Filename: fbgemm_gpu_nightly_cpu-2023.7.5.dist-info/top_level.txt
 Comment: 
 
-Filename: fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/RECORD
...
## Comparing `fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/METADATA` & `fbgemm_gpu_nightly_cpu-2023.7.5.dist-info/METADATA`
...
## Comparing `fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/RECORD` & `fbgemm_gpu_nightly_cpu-2023.7.5.dist-info/RECORD`
...
-fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/METADATA,sha256=KIdBTFubb5WyQp4vy1_Es6El0V0N1g8nDVymVjg0NH4,2933
-fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/WHEEL,sha256=uNTrmykJsfnOiRowEmEAgdbSsr7BScgAFZq1d9YxSqA,105
-fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/top_level.txt,sha256=2tlbTWLkPjhqvLF_6BbqKzkcPluSE-oPRVjI8axK76I,11
-fbgemm_gpu_nightly_cpu-2023.7.4.dist-info/RECORD,,
