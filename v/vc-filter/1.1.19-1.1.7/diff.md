# Comparing `tmp/vc_filter-1.1.19.tar.gz` & `tmp/vc-filter-1.1.7.tar.gz`
...
## Comparing `vc_filter-1.1.19.tar` & `vc-filter-1.1.7.tar`
...
### Comparing `vc_filter-1.1.19/README.md` & `vc-filter-1.1.7/README.md`

 * *Files identical despite different names*

### Comparing `vc_filter-1.1.19/vc_filter/code.py` & `vc-filter-1.1.7/vc_filter/code.py`
...
### Comparing `vc_filter-1.1.19/PKG-INFO` & `vc-filter-1.1.7/PKG-INFO`
