# Comparing `tmp/vc_filter-1.1.17.tar.gz` & `tmp/vc-filter-1.1.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "vc_filter-1.1.17.tar", max compression
+gzip compressed data, was "vc-filter-1.1.7.tar", last modified: Sun Jun 25 07:57:13 2023, max compression
```

## Comparing `vc_filter-1.1.17.tar` & `vc-filter-1.1.7.tar`

### file list

```diff
@@ -1,6 +1,14 @@
--rw-r--r--   0        0        0     2762 2022-01-30 19:57:29.984822 vc_filter-1.1.17/README.md
--rw-r--r--   0        0        0      448 2023-07-05 11:47:52.331549 vc_filter-1.1.17/pyproject.toml
--rw-r--r--   0        0        0     6148 2023-07-05 11:00:46.490166 vc_filter-1.1.17/vc_filter/.DS_Store
--rw-r--r--   0        0        0        1 2023-07-04 12:52:11.005321 vc_filter-1.1.17/vc_filter/__init__.py
--rw-r--r--   0        0        0     5128 2023-07-04 12:36:37.709170 vc_filter-1.1.17/vc_filter/code.py
--rw-r--r--   0        0        0     3364 1970-01-01 00:00:00.000000 vc_filter-1.1.17/PKG-INFO
...
### Comparing `vc_filter-1.1.17/README.md` & `vc-filter-1.1.7/README.md`

 * *Files identical despite different names*

### Comparing `vc_filter-1.1.17/vc_filter/code.py` & `vc-filter-1.1.7/vc_filter/code.py`
...
### Comparing `vc_filter-1.1.17/PKG-INFO` & `vc-filter-1.1.7/PKG-INFO`
