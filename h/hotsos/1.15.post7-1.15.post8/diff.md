# Comparing `tmp/hotsos-1.15.post7.tar.gz` & `tmp/hotsos-1.15.post8.tar.gz`
...
### Comparing `hotsos-1.15.post7/LICENSE` & `hotsos-1.15.post8/LICENSE`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/PKG-INFO` & `hotsos-1.15.post8/PKG-INFO`
...
### Comparing `hotsos-1.15.post7/hotsos/cli.py` & `hotsos-1.15.post8/hotsos/cli.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/client.py` & `hotsos-1.15.post8/hotsos/client.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/analytics.py` & `hotsos-1.15.post8/hotsos/core/analytics.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/config.py` & `hotsos-1.15.post8/hotsos/core/config.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/factory.py` & `hotsos-1.15.post8/hotsos/core/factory.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/__init__.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/__init__.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/cli.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/cli.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/common.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/config.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/config.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/filestat.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/filestat.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/network.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/network.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/packaging.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/packaging.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/pebble.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/pebble.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/ssl.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/ssl.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/sysctl.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/sysctl.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/systemd.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/systemd.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/host_helpers/uptime.py` & `hotsos-1.15.post8/hotsos/core/host_helpers/uptime.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/issues/issue_types.py` & `hotsos-1.15.post8/hotsos/core/issues/issue_types.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/issues/utils.py` & `hotsos-1.15.post8/hotsos/core/issues/utils.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/log.py` & `hotsos-1.15.post8/hotsos/core/log.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/juju/common.py` & `hotsos-1.15.post8/hotsos/core/plugins/juju/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/juju/resources.py` & `hotsos-1.15.post8/hotsos/core/plugins/juju/resources.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/common.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/config.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/config.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/kernlog/calltrace.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/kernlog/calltrace.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/kernlog/common.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/kernlog/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/kernlog/events.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/kernlog/events.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/memory.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/memory.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/net.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/net.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kernel/sysfs.py` & `hotsos-1.15.post8/hotsos/core/plugins/kernel/sysfs.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/kubernetes.py` & `hotsos-1.15.post8/hotsos/core/plugins/kubernetes.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/lxd/common.py` & `hotsos-1.15.post8/hotsos/core/plugins/lxd/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/maas.py` & `hotsos-1.15.post8/hotsos/core/plugins/maas.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/mysql.py` & `hotsos-1.15.post8/hotsos/core/plugins/mysql.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openstack/common.py` & `hotsos-1.15.post8/hotsos/core/plugins/openstack/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openstack/exceptions.py` & `hotsos-1.15.post8/hotsos/core/plugins/openstack/exceptions.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openstack/neutron.py` & `hotsos-1.15.post8/hotsos/core/plugins/openstack/neutron.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openstack/nova.py` & `hotsos-1.15.post8/hotsos/core/plugins/openstack/nova.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openstack/octavia.py` & `hotsos-1.15.post8/hotsos/core/plugins/openstack/octavia.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openstack/openstack.py` & `hotsos-1.15.post8/hotsos/core/plugins/openstack/openstack.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openvswitch/common.py` & `hotsos-1.15.post8/hotsos/core/plugins/openvswitch/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openvswitch/ovn.py` & `hotsos-1.15.post8/hotsos/core/plugins/openvswitch/ovn.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/openvswitch/ovs.py` & `hotsos-1.15.post8/hotsos/core/plugins/openvswitch/ovs.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/pacemaker.py` & `hotsos-1.15.post8/hotsos/core/plugins/pacemaker.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/rabbitmq/common.py` & `hotsos-1.15.post8/hotsos/core/plugins/rabbitmq/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/rabbitmq/report.py` & `hotsos-1.15.post8/hotsos/core/plugins/rabbitmq/report.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/sosreport.py` & `hotsos-1.15.post8/hotsos/core/plugins/sosreport.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/storage/bcache.py` & `hotsos-1.15.post8/hotsos/core/plugins/storage/bcache.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/storage/ceph.py` & `hotsos-1.15.post8/hotsos/core/plugins/storage/ceph.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/system/system.py` & `hotsos-1.15.post8/hotsos/core/plugins/system/system.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugins/vault.py` & `hotsos-1.15.post8/hotsos/core/plugins/vault.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/plugintools.py` & `hotsos-1.15.post8/hotsos/core/plugintools.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/search.py` & `hotsos-1.15.post8/hotsos/core/search.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/utils.py` & `hotsos-1.15.post8/hotsos/core/utils.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/common.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/checks.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/checks.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/common.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/conclusions.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/conclusions.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/input.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/input.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/common.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/common.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/requires.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/requires.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/apt.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/apt.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/config.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/config.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/path.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/path.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/pebble.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/pebble.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/property.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/property.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/snap.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/snap.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/systemd.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/systemd.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/requires/types/varops.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/requires/types/varops.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/search.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/search.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/engine/properties/vars.py` & `hotsos-1.15.post8/hotsos/core/ycheck/engine/properties/vars.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/events.py` & `hotsos-1.15.post8/hotsos/core/ycheck/events.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/core/ycheck/scenarios.py` & `hotsos-1.15.post8/hotsos/core/ycheck/scenarios.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/openstack/neutron/agents.yaml` & `hotsos-1.15.post8/hotsos/defs/events/openstack/neutron/agents.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/openstack/nova/external-events.yaml` & `hotsos-1.15.post8/hotsos/defs/events/openstack/nova/external-events.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/openstack/octavia.yaml` & `hotsos-1.15.post8/hotsos/defs/events/openstack/octavia.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/openvswitch/ovn/errors-and-warnings.yaml` & `hotsos-1.15.post8/hotsos/defs/events/openvswitch/ovn/errors-and-warnings.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/openvswitch/ovn/ovn-central.yaml` & `hotsos-1.15.post8/hotsos/defs/events/openvswitch/ovn/ovn-central.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/openvswitch/ovn/ovn-controller.yaml` & `hotsos-1.15.post8/hotsos/defs/events/openvswitch/ovn/ovn-controller.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/openvswitch/ovs/ovs-vswitchd.yaml` & `hotsos-1.15.post8/hotsos/defs/events/openvswitch/ovs/ovs-vswitchd.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/events/storage/ceph/mon/monlogs.yaml` & `hotsos-1.15.post8/hotsos/defs/events/storage/ceph/mon/monlogs.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/bugs/lp1812361.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/bugs/lp1812361.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/bugs/lp1852502.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/bugs/lp1852502.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/bugs/lp1858519.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/bugs/lp1858519.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/bugs/lp1895040.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/bugs/lp1895040.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/bugs/lp1910958.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/bugs/lp1910958.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/bugs/lp1948906.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/bugs/lp1948906.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/bugs/lp1996230.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/bugs/lp1996230.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/juju/charm_unit_checks.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/juju/charm_unit_checks.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kernel/amd_iommu_pt.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kernel/amd_iommu_pt.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kernel/kernlog_calltrace.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kernel/kernlog_calltrace.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kernel/memory.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kernel/memory.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kernel/network/misc.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kernel/network/misc.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kernel/network/tcp.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kernel/network/tcp.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kernel/network/udp.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kernel/network/udp.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kernel/qla2xxx.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kernel/qla2xxx.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/kubernetes/system_cpufreq_mode.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/kubernetes/system_cpufreq_mode.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/lxd/bugs/lp1807628.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/lxd/bugs/lp1807628.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/lxd/lxcfs_deadlock.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/lxd/lxcfs_deadlock.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/mysql/bugs/lp1959861.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/mysql/bugs/lp1959861.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/mysql/bugs/lp1971565.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/mysql/bugs/lp1971565.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/mysql/mysql_connections.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/mysql/mysql_connections.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/barbican/bugs/lp1946787.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/barbican/bugs/lp1946787.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/eol.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/eol.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/keystone/bugs/lp1896125.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/keystone/bugs/lp1896125.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/masakari/pacemaker_remote.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/masakari/pacemaker_remote.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/bugs/lp1794991.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/bugs/lp1794991.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/bugs/lp1907686.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/bugs/lp1907686.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/bugs/lp1927868.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/bugs/lp1927868.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/bugs/lp1960319.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/bugs/lp1960319.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/bugs/lp1979089.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/bugs/lp1979089.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/bugs/lp1993628.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/bugs/lp1993628.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/bugs/lp1996594.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/bugs/lp1996594.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/neutron_ovs_cleanup.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/neutron_ovs_cleanup.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/neutron/ovn_stale_db.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/neutron/ovn_stale_db.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/nova/bugs/lp1860743.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/nova/bugs/lp1860743.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/nova/bugs/lp1888395.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/nova/bugs/lp1888395.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/nova/bugs/lp1904580.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/nova/bugs/lp1904580.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/nova/bugs/lp1967956.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/nova/bugs/lp1967956.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/nova/config_checks.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/nova/config_checks.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/nova/cpu_pinning.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/nova/cpu_pinning.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/nova/service_mem_usage.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/nova/service_mem_usage.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/octavia/bugs/sb1896125.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/octavia/bugs/sb1896125.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/octavia/excessive_failovers.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/octavia/excessive_failovers.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/octavia/hm_port_health.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/octavia/hm_port_health.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/openstack_apache2_certificates.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/openstack_apache2_certificates.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/openstack_charm_conflicts.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/openstack_charm_conflicts.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/system_cpufreq_mode.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/system_cpufreq_mode.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openstack/systemd_masked_services.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openstack/systemd_masked_services.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/bugs/lp1839592.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/bugs/lp1839592.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/bugs/lp1978806.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/bugs/lp1978806.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/dpif_lost_packets.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/dpif_lost_packets.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/dpif_resubmit_actions.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/dpif_resubmit_actions.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/bfd_flapping.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/bfd_flapping.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/bugs/lp1865127.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/bugs/lp1865127.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/ovn_central_certs_logs.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/ovn_central_certs_logs.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/ovn_central_services.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/ovn_central_services.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/ovn_certs_valid.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/ovn_certs_valid.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/ovn_chassis_certs_logs.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/ovn_chassis_certs_logs.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/ovn_db_upgrade.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/ovn_db_upgrade.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/ovn_elections.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/ovn_elections.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/ovsdb_reconnect_errors.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/ovsdb_reconnect_errors.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/ovn/service_mem_usage.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/ovn/service_mem_usage.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/openvswitch/service_restarts.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/openvswitch/service_restarts.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/pacemaker/bugs/lp1874719.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/pacemaker/bugs/lp1874719.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/rabbitmq/bugs/lp1943937.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/rabbitmq/bugs/lp1943937.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/rabbitmq/cluster_config.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/rabbitmq/cluster_config.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/rabbitmq/cluster_logchecks.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/rabbitmq/cluster_logchecks.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/rabbitmq/cluster_resources.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/rabbitmq/cluster_resources.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/sosreport/plugin_timeouts.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/sosreport/plugin_timeouts.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/bcache/bdev.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/bcache/bdev.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/bcache/cacheset.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/bcache/cacheset.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mgr/autoscaler_overlap_roots.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mgr/autoscaler_overlap_roots.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/auth_insecure_global_id_reclaim_allowed.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/auth_insecure_global_id_reclaim_allowed.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/autoscaler_bug.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/autoscaler_bug.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/bluefs_size.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/bluefs_size.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/bluefs_spillover.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/bluefs_spillover.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph-mon.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph-mon.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph_address_overlap.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph_address_overlap.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph_cluster_health.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph_cluster_health.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph_versions_mismatch.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/ceph_versions_mismatch.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/crushmap_bucket_checks.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/crushmap_bucket_checks.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/empty_clog.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/empty_clog.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/eol.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/eol.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/laggy_pgs.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/laggy_pgs.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/large_omap_objects.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/large_omap_objects.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/meta_backend_mon.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/meta_backend_mon.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/mon_db_too_big.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/mon_db_too_big.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/mon_elections_flapping.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/mon_elections_flapping.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_flapping.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_flapping.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_maps_backlog_too_large.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_maps_backlog_too_large.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_messenger_v2_protocol.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_messenger_v2_protocol.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_slow_heartbeats.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_slow_heartbeats.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_slow_ops.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/osd_slow_ops.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/pg_imbalance.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/pg_imbalance.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/pg_overdose.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/pg_overdose.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/required_osd_release_mismatch.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/required_osd_release_mismatch.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/rgw_frontend.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/rgw_frontend.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/ssds_using_bcache.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/ssds_using_bcache.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-mon/unresponsive_mon_mgr.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-mon/unresponsive_mon_mgr.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp1936136.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp1936136.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp1959649.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp1959649.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp1996010.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp1996010.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp2013960.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp2013960.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp2016845.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/bugs/lp2016845.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/ceph_address_overlap.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/ceph_address_overlap.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/eol.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/eol.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/filestore_to_bluestore_upgrade.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/filestore_to_bluestore_upgrade.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/juju_ceph_no_bcache_tuning.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/juju_ceph_no_bcache_tuning.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/meta_backend_osd.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/meta_backend_osd.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/osd_flapping.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/osd_flapping.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/osd_latency.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/osd_latency.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/osd_slow_ops.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/osd_slow_ops.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/pg_overdose.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/pg_overdose.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/ssd_osds_no_discard.yaml.disabled` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/ssd_osds_no_discard.yaml.disabled`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-osd/system_cpufreq_mode.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-osd/system_cpufreq_mode.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/ceph-rgw/rgw_frontend_rgw.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/ceph-rgw/rgw_frontend_rgw.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/defs/scenarios/storage/ceph/common/ceph_charm_conflicts.yaml` & `hotsos-1.15.post8/hotsos/defs/scenarios/storage/ceph/common/ceph_charm_conflicts.yaml`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/juju/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/juju/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/kernel/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/kernel/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/kubernetes/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/kubernetes/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/lxd/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/lxd/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openstack/agent/events.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openstack/agent/events.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openstack/agent/exceptions.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openstack/agent/exceptions.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openstack/nova_external_events.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openstack/nova_external_events.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openstack/service_features.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openstack/service_features.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openstack/service_network_checks.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openstack/service_network_checks.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openstack/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openstack/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openstack/vm_info.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openstack/vm_info.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openvswitch/event_checks.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openvswitch/event_checks.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/openvswitch/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/openvswitch/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/pacemaker/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/pacemaker/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/rabbitmq/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/rabbitmq/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/sosreport/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/sosreport/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/storage/bcache_summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/storage/bcache_summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/storage/ceph_event_checks.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/storage/ceph_event_checks.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/storage/ceph_summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/storage/ceph_summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/system/checks.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/system/checks.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/plugin_extensions/system/summary.py` & `hotsos-1.15.post8/hotsos/plugin_extensions/system/summary.py`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos/templates/header.html` & `hotsos-1.15.post8/hotsos/templates/header.html`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/hotsos.egg-info/PKG-INFO` & `hotsos-1.15.post8/hotsos.egg-info/PKG-INFO`
...
### Comparing `hotsos-1.15.post7/hotsos.egg-info/SOURCES.txt` & `hotsos-1.15.post8/hotsos.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `hotsos-1.15.post7/pyproject.toml` & `hotsos-1.15.post8/pyproject.toml`
