# Comparing `tmp/hydrogibs-0.0.21.tar.gz` & `tmp/hydrogibs-0.5.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hydrogibs-0.0.21.tar", last modified: Wed Jul  5 07:17:40 2023, max compression
+gzip compressed data, was "hydrogibs-0.5.2.tar", last modified: Mon Jul  3 15:13:24 2023, max compression
```

## Comparing `hydrogibs-0.0.21.tar` & `hydrogibs-0.5.2.tar`

### file list

```diff
@@ -1,13 +1,12 @@
-drwxrwxr-x   0 axel      (1000) axel      (1000)        0 2023-07-05 07:17:40.448726 hydrogibs-0.0.21/
--rw-rw-r--   0 axel      (1000) axel      (1000)     1073 2023-04-23 13:58:07.000000 hydrogibs-0.0.21/LICENSE
--rw-rw-r--   0 axel      (1000) axel      (1000)     1416 2023-07-05 07:17:40.448726 hydrogibs-0.0.21/PKG-INFO
--rw-rw-r--   0 axel      (1000) axel      (1000)     1008 2023-05-23 16:56:32.000000 hydrogibs-0.0.21/README.md
-drwxrwxr-x   0 axel      (1000) axel      (1000)        0 2023-07-05 07:17:40.448726 hydrogibs-0.0.21/hydrogibs/
-drwxrwxr-x   0 axel      (1000) axel      (1000)        0 2023-07-05 07:17:40.448726 hydrogibs-0.0.21/hydrogibs/hydrogibs.egg-info/
--rw-rw-r--   0 axel      (1000) axel      (1000)     1416 2023-07-05 07:17:40.000000 hydrogibs-0.0.21/hydrogibs/hydrogibs.egg-info/PKG-INFO
--rw-rw-r--   0 axel      (1000) axel      (1000)      240 2023-07-05 07:17:40.000000 hydrogibs-0.0.21/hydrogibs/hydrogibs.egg-info/SOURCES.txt
--rw-rw-r--   0 axel      (1000) axel      (1000)        1 2023-07-05 07:17:40.000000 hydrogibs-0.0.21/hydrogibs/hydrogibs.egg-info/dependency_links.txt
--rw-rw-r--   0 axel      (1000) axel      (1000)       44 2023-07-05 07:17:40.000000 hydrogibs-0.0.21/hydrogibs/hydrogibs.egg-info/requires.txt
--rw-rw-r--   0 axel      (1000) axel      (1000)        1 2023-07-05 07:17:40.000000 hydrogibs-0.0.21/hydrogibs/hydrogibs.egg-info/top_level.txt
--rw-rw-r--   0 axel      (1000) axel      (1000)       38 2023-07-05 07:17:40.452726 hydrogibs-0.0.21/setup.cfg
--rw-rw-r--   0 axel      (1000) axel      (1000)      753 2023-07-05 07:17:36.000000 hydrogibs-0.0.21/setup.py
...
### Comparing `hydrogibs-0.0.21/LICENSE` & `hydrogibs-0.5.2/LICENSE`

 * *Files identical despite different names*

### Comparing `hydrogibs-0.0.21/PKG-INFO` & `hydrogibs-0.5.2/README.md`
