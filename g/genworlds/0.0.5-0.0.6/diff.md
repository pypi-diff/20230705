# Comparing `tmp/genworlds-0.0.5.tar.gz` & `tmp/genworlds-0.0.6.tar.gz`
...
### Comparing `genworlds-0.0.5/genworlds/interfaces/cli/render_help_screen.py` & `genworlds-0.0.6/genworlds/interfaces/cli/render_help_screen.py`
