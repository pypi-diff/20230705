# Comparing `tmp/irisml-tasks-training-0.0.82.tar.gz` & `tmp/irisml-tasks-training-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "irisml-tasks-training-0.0.82.tar", last modified: Wed Jul  5 20:14:41 2023, max compression
+gzip compressed data, was "irisml-tasks-training-0.0.9.tar", last modified: Wed Aug 10 05:23:37 2022, max compression
```

## Comparing `irisml-tasks-training-0.0.82.tar` & `irisml-tasks-training-0.0.9.tar`

### file list

```diff
@@ -1,111 +1,59 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-05 20:14:41.252753 irisml-tasks-training-0.0.82/
--rw-r--r--   0 runner    (1001) docker     (123)     1141 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     5366 2023-07-05 20:14:41.252753 irisml-tasks-training-0.0.82/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     5080 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-05 20:14:41.224753 irisml-tasks-training-0.0.82/irisml/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-05 20:14:41.236753 irisml-tasks-training-0.0.82/irisml/tasks/
--rw-r--r--   0 runner    (1001) docker     (123)     1654 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/append_classifier.py
--rw-r--r--   0 runner    (1001) docker     (123)     1889 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/benchmark_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     9063 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/benchmark_model.py
--rw-r--r--   0 runner    (1001) docker     (123)     2403 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/benchmark_model_with_grad_cache.py
--rw-r--r--   0 runner    (1001) docker     (123)     1380 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/build_classification_prompt_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     2395 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/build_zero_shot_classifier.py
--rw-r--r--   0 runner    (1001) docker     (123)     4821 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/concatenate_datasets.py
--rw-r--r--   0 runner    (1001) docker     (123)     4928 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/create_classification_prompt_generator.py
--rw-r--r--   0 runner    (1001) docker     (123)     1971 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/evaluate_accuracy.py
--rw-r--r--   0 runner    (1001) docker     (123)     5107 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/evaluate_detection_average_precision.py
--rw-r--r--   0 runner    (1001) docker     (123)     1642 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/exclude_negative_samples_from_classification_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     1152 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/export_onnx.py
--rw-r--r--   0 runner    (1001) docker     (123)     1379 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/find_incorrect_classification_indices.py
--rw-r--r--   0 runner    (1001) docker     (123)     2192 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/find_incorrect_classification_multilabel_indices.py
--rw-r--r--   0 runner    (1001) docker     (123)     2223 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/get_subclass_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     2903 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/get_targets_from_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     2381 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/load_simple_classification_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     2362 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_classification_dataset_from_object_detection.py
--rw-r--r--   0 runner    (1001) docker     (123)     1739 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_classification_dataset_from_predictions.py
--rw-r--r--   0 runner    (1001) docker     (123)     2309 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_feature_extractor_model.py
--rw-r--r--   0 runner    (1001) docker     (123)     1313 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_fixed_prompt_image_transform.py
--rw-r--r--   0 runner    (1001) docker     (123)     1035 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_fixed_text_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     5567 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_image_text_contrastive_model.py
--rw-r--r--   0 runner    (1001) docker     (123)     2563 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_image_text_transform.py
--rw-r--r--   0 runner    (1001) docker     (123)     4482 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_oversampled_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     1418 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/make_prompt_list_image_transform.py
--rw-r--r--   0 runner    (1001) docker     (123)      706 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/num_iters_to_epochs.py
--rw-r--r--   0 runner    (1001) docker     (123)     9014 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/predict.py
--rw-r--r--   0 runner    (1001) docker     (123)     1575 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/remove_empty_images_from_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     3560 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/sample_few_shot_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     2044 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/split_image_text_model.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-05 20:14:41.240753 irisml-tasks-training-0.0.82/irisml/tasks/train/
--rw-r--r--   0 runner    (1001) docker     (123)      133 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     4887 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/build_dataloader.py
--rw-r--r--   0 runner    (1001) docker     (123)     5374 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/build_lr_scheduler.py
--rw-r--r--   0 runner    (1001) docker     (123)     4766 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/build_optimizer.py
--rw-r--r--   0 runner    (1001) docker     (123)     5041 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/ddp_trainer.py
--rw-r--r--   0 runner    (1001) docker     (123)     6967 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/ddp_utils.py
--rw-r--r--   0 runner    (1001) docker     (123)     3991 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugin_list.py
--rw-r--r--   0 runner    (1001) docker     (123)     1627 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugin_loader.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-05 20:14:41.244753 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/
--rw-r--r--   0 runner    (1001) docker     (123)     1692 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/amp.py
--rw-r--r--   0 runner    (1001) docker     (123)      620 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/clip_grad_norm.py
--rw-r--r--   0 runner    (1001) docker     (123)      772 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/compile.py
--rw-r--r--   0 runner    (1001) docker     (123)      317 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/ddp.py
--rw-r--r--   0 runner    (1001) docker     (123)      616 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/detect_anomaly.py
--rw-r--r--   0 runner    (1001) docker     (123)     2200 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/early_stopping.py
--rw-r--r--   0 runner    (1001) docker     (123)     3621 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/ema.py
--rw-r--r--   0 runner    (1001) docker     (123)     1356 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/fp16.py
--rw-r--r--   0 runner    (1001) docker     (123)     1093 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/freeze_modules.py
--rw-r--r--   0 runner    (1001) docker     (123)     2726 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/freeze_modules_upto.py
--rw-r--r--   0 runner    (1001) docker     (123)     1135 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/heartbeat.py
--rw-r--r--   0 runner    (1001) docker     (123)     2383 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/log_summary.py
--rw-r--r--   0 runner    (1001) docker     (123)      995 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/log_tensorboard.py
--rw-r--r--   0 runner    (1001) docker     (123)     2952 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/mixup.py
--rw-r--r--   0 runner    (1001) docker     (123)      171 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/nop.py
--rw-r--r--   0 runner    (1001) docker     (123)     2028 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/plugin_base.py
--rw-r--r--   0 runner    (1001) docker     (123)     2031 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/progressbar.py
--rw-r--r--   0 runner    (1001) docker     (123)      470 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/scale_loss.py
--rw-r--r--   0 runner    (1001) docker     (123)     4046 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/step_decay_ema.py
--rw-r--r--   0 runner    (1001) docker     (123)     6522 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/task.py
--rw-r--r--   0 runner    (1001) docker     (123)     6331 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train/trainer.py
--rw-r--r--   0 runner    (1001) docker     (123)     9884 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/irisml/tasks/train_with_gradient_cache.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-05 20:14:41.244753 irisml-tasks-training-0.0.82/irisml_tasks_training.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     5366 2023-07-05 20:14:41.000000 irisml-tasks-training-0.0.82/irisml_tasks_training.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     4167 2023-07-05 20:14:41.000000 irisml-tasks-training-0.0.82/irisml_tasks_training.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-05 20:14:41.000000 irisml-tasks-training-0.0.82/irisml_tasks_training.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       48 2023-07-05 20:14:41.000000 irisml-tasks-training-0.0.82/irisml_tasks_training.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        7 2023-07-05 20:14:41.000000 irisml-tasks-training-0.0.82/irisml_tasks_training.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       81 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)      573 2023-07-05 20:14:41.252753 irisml-tasks-training-0.0.82/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-05 20:14:41.252753 irisml-tasks-training-0.0.82/test/
--rw-r--r--   0 runner    (1001) docker     (123)      609 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_append_classifier.py
--rw-r--r--   0 runner    (1001) docker     (123)      485 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_benchmark_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     3384 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_benchmark_model.py
--rw-r--r--   0 runner    (1001) docker     (123)      708 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_build_classification_prompt_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     1889 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_build_zero_shot_classifier.py
--rw-r--r--   0 runner    (1001) docker     (123)     5566 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_concatenate_datasets.py
--rw-r--r--   0 runner    (1001) docker     (123)     1001 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_create_classification_prompt_generator.py
--rw-r--r--   0 runner    (1001) docker     (123)     1412 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_ddp_trainer.py
--rw-r--r--   0 runner    (1001) docker     (123)     1408 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_evaluate_accuracy.py
--rw-r--r--   0 runner    (1001) docker     (123)      741 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_evaluate_detection_average_precision.py
--rw-r--r--   0 runner    (1001) docker     (123)      741 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_exclude_negative_samples_from_classification_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     1780 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_export_onnx.py
--rw-r--r--   0 runner    (1001) docker     (123)     1334 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_find_incorrect_classification_indices.py
--rw-r--r--   0 runner    (1001) docker     (123)     1075 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_find_incorrect_classification_multilabel_indices.py
--rw-r--r--   0 runner    (1001) docker     (123)     2098 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_get_subclass_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     1569 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_get_targets_from_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)      164 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_irisml.py
--rw-r--r--   0 runner    (1001) docker     (123)     1453 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_load_simple_classification_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     3947 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_classification_dataset_from_object_detection.py
--rw-r--r--   0 runner    (1001) docker     (123)     1496 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_classification_dataset_from_predictions.py
--rw-r--r--   0 runner    (1001) docker     (123)     1299 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_feature_extractor_model.py
--rw-r--r--   0 runner    (1001) docker     (123)      904 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_fixed_prompt_image_transform.py
--rw-r--r--   0 runner    (1001) docker     (123)      511 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_fixed_text_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)      768 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_image_text_contrastive_model.py
--rw-r--r--   0 runner    (1001) docker     (123)     1551 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_image_text_transform.py
--rw-r--r--   0 runner    (1001) docker     (123)     2063 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_oversampled_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     1008 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_make_prompt_list_image_transform.py
--rw-r--r--   0 runner    (1001) docker     (123)      609 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_num_iters_to_epochs.py
--rw-r--r--   0 runner    (1001) docker     (123)     5096 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_predict.py
--rw-r--r--   0 runner    (1001) docker     (123)     1217 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_remove_empty_images_from_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)     2856 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_sample_few_shot_dataset.py
--rw-r--r--   0 runner    (1001) docker     (123)      827 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_split_image_text_model.py
--rw-r--r--   0 runner    (1001) docker     (123)     7814 2023-07-05 20:10:54.000000 irisml-tasks-training-0.0.82/test/test_train_with_gradient_cache.py
...
### Comparing `irisml-tasks-training-0.0.82/LICENSE` & `irisml-tasks-training-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/PKG-INFO` & `irisml-tasks-training-0.0.9/PKG-INFO`
...
### Comparing `irisml-tasks-training-0.0.82/README.md` & `irisml-tasks-training-0.0.9/irisml_tasks_training.egg-info/PKG-INFO`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/append_classifier.py` & `irisml-tasks-training-0.0.9/irisml/tasks/append_classifier.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/build_classification_prompt_dataset.py` & `irisml-tasks-training-0.0.9/irisml/tasks/build_classification_prompt_dataset.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/build_zero_shot_classifier.py` & `irisml-tasks-training-0.0.9/irisml/tasks/build_zero_shot_classifier.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/evaluate_detection_average_precision.py` & `irisml-tasks-training-0.0.9/irisml/tasks/evaluate_detection_average_precision.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/export_onnx.py` & `irisml-tasks-training-0.0.9/irisml/tasks/export_onnx.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/make_feature_extractor_model.py` & `irisml-tasks-training-0.0.9/irisml/tasks/make_feature_extractor_model.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/make_image_text_contrastive_model.py` & `irisml-tasks-training-0.0.9/irisml/tasks/make_image_text_contrastive_model.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/make_image_text_transform.py` & `irisml-tasks-training-0.0.9/irisml/tasks/make_image_text_transform.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/num_iters_to_epochs.py` & `irisml-tasks-training-0.0.9/irisml/tasks/get_targets_from_dataset.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/predict.py` & `irisml-tasks-training-0.0.9/irisml/tasks/predict.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/train/build_dataloader.py` & `irisml-tasks-training-0.0.9/irisml/tasks/train/build_dataloader.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/train/ddp_trainer.py` & `irisml-tasks-training-0.0.9/irisml/tasks/train/ddp_trainer.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/train/plugin_list.py` & `irisml-tasks-training-0.0.9/irisml/tasks/train/plugin_list.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/log_summary.py` & `irisml-tasks-training-0.0.9/irisml/tasks/train/plugins/log_summary.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/log_tensorboard.py` & `irisml-tasks-training-0.0.9/irisml/tasks/train/plugins/log_tensorboard.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/train/plugins/progressbar.py` & `irisml-tasks-training-0.0.9/irisml/tasks/train/plugins/progressbar.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml/tasks/train/trainer.py` & `irisml-tasks-training-0.0.9/irisml/tasks/train/trainer.py`
...
### Comparing `irisml-tasks-training-0.0.82/irisml_tasks_training.egg-info/PKG-INFO` & `irisml-tasks-training-0.0.9/README.md`
...
### Comparing `irisml-tasks-training-0.0.82/test/test_append_classifier.py` & `irisml-tasks-training-0.0.9/test/test_append_classifier.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/test/test_build_classification_prompt_dataset.py` & `irisml-tasks-training-0.0.9/test/test_build_classification_prompt_dataset.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/test/test_build_zero_shot_classifier.py` & `irisml-tasks-training-0.0.9/test/test_build_zero_shot_classifier.py`
...
### Comparing `irisml-tasks-training-0.0.82/test/test_ddp_trainer.py` & `irisml-tasks-training-0.0.9/test/test_ddp_trainer.py`
...
### Comparing `irisml-tasks-training-0.0.82/test/test_evaluate_accuracy.py` & `irisml-tasks-training-0.0.9/test/test_evaluate_accuracy.py`
...
### Comparing `irisml-tasks-training-0.0.82/test/test_evaluate_detection_average_precision.py` & `irisml-tasks-training-0.0.9/test/test_evaluate_detection_average_precision.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/test/test_make_feature_extractor_model.py` & `irisml-tasks-training-0.0.9/test/test_make_feature_extractor_model.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/test/test_make_image_text_contrastive_model.py` & `irisml-tasks-training-0.0.9/test/test_make_image_text_contrastive_model.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/test/test_make_image_text_transform.py` & `irisml-tasks-training-0.0.9/test/test_make_image_text_transform.py`

 * *Files identical despite different names*

### Comparing `irisml-tasks-training-0.0.82/test/test_split_image_text_model.py` & `irisml-tasks-training-0.0.9/irisml/tasks/split_image_text_model.py`
