# Comparing `tmp/irene_pro-0.0.80.tar.gz` & `tmp/irene_pro-0.0.81.tar.gz`
...
## Comparing `irene_pro-0.0.80.tar` & `irene_pro-0.0.81.tar`
...
### Comparing `irene_pro-0.0.80/PKG-INFO` & `irene_pro-0.0.81/PKG-INFO`
...
### Comparing `irene_pro-0.0.80/README.md` & `irene_pro-0.0.81/README.md`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.80/irene_pro/widgets.py` & `irene_pro-0.0.81/irene_pro/widgets.py`
...
### Comparing `irene_pro-0.0.80/irene_pro.egg-info/PKG-INFO` & `irene_pro-0.0.81/irene_pro.egg-info/PKG-INFO`
...
### Comparing `irene_pro-0.0.80/setup.py` & `irene_pro-0.0.81/setup.py`
