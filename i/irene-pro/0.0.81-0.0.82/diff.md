# Comparing `tmp/irene_pro-0.0.81.tar.gz` & `tmp/irene_pro-0.0.82.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "irene_pro-0.0.81.tar", last modified: Wed Jul  5 11:53:38 2023, max compression
+gzip compressed data, was "irene_pro-0.0.82.tar", last modified: Wed Jul  5 12:29:54 2023, max compression
```

## Comparing `irene_pro-0.0.81.tar` & `irene_pro-0.0.82.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxrwxrwx   0        0        0        0 2023-07-05 11:53:38.506391 irene_pro-0.0.81/
--rw-rw-rw-   0        0        0      227 2023-06-30 07:10:26.000000 irene_pro-0.0.81/LICENSE
--rw-rw-rw-   0        0        0       14 2023-06-30 07:10:26.000000 irene_pro-0.0.81/MANIFEST.in
--rw-rw-rw-   0        0        0     1280 2023-07-05 11:53:38.504394 irene_pro-0.0.81/PKG-INFO
--rw-rw-rw-   0        0        0      715 2023-06-30 07:10:26.000000 irene_pro-0.0.81/README.md
-drwxrwxrwx   0        0        0        0 2023-07-05 11:53:37.143136 irene_pro-0.0.81/irene_pro/
--rw-rw-rw-   0        0        0        0 2023-06-30 07:27:47.000000 irene_pro-0.0.81/irene_pro/__init__.py
--rw-rw-rw-   0        0        0     8063 2023-07-05 09:10:33.000000 irene_pro-0.0.81/irene_pro/logics.py
--rw-rw-rw-   0        0        0    35748 2023-07-05 08:54:43.000000 irene_pro-0.0.81/irene_pro/widgets.py
-drwxrwxrwx   0        0        0        0 2023-07-05 11:53:38.221108 irene_pro-0.0.81/irene_pro.egg-info/
--rw-rw-rw-   0        0        0     1280 2023-07-05 11:53:34.000000 irene_pro-0.0.81/irene_pro.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      265 2023-07-05 11:53:34.000000 irene_pro-0.0.81/irene_pro.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-07-05 11:53:34.000000 irene_pro-0.0.81/irene_pro.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       59 2023-07-05 11:53:34.000000 irene_pro-0.0.81/irene_pro.egg-info/requires.txt
--rw-rw-rw-   0        0        0       10 2023-07-05 11:53:34.000000 irene_pro-0.0.81/irene_pro.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-07-05 11:53:38.507386 irene_pro-0.0.81/setup.cfg
--rw-rw-rw-   0        0        0     1164 2023-07-05 11:49:46.000000 irene_pro-0.0.81/setup.py
...
### Comparing `irene_pro-0.0.81/PKG-INFO` & `irene_pro-0.0.82/PKG-INFO`
...
### Comparing `irene_pro-0.0.81/README.md` & `irene_pro-0.0.82/README.md`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.81/irene_pro/logics.py` & `irene_pro-0.0.82/irene_pro/logics.py`
...
-        seconds = DateTime().convert_to_seconds(datetime_str=time_between)
...
+        seconds = DateTime().convert_to_seconds(datetime_str=str(time_between))
     ...
     def date_is_back(self, time1, time2):
         time_between = DateTime().datedelta(start = time1, end = time2)
-        seconds = DateTime().convert_to_seconds(datetime_str=time_between)
+        print(f"TIME BETWEEN 2: {time_between}")
+        seconds = DateTime().convert_to_seconds(datetime_str=str(time_between))
         if seconds < 0:
             return True
...
### Comparing `irene_pro-0.0.81/irene_pro/widgets.py` & `irene_pro-0.0.82/irene_pro/widgets.py`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.81/irene_pro.egg-info/PKG-INFO` & `irene_pro-0.0.82/irene_pro.egg-info/PKG-INFO`
...
### Comparing `irene_pro-0.0.81/setup.py` & `irene_pro-0.0.82/setup.py`
...
-00000100: 2027 302e 302e 3831 270d 0a44 4553 4352   '0.0.81'..DESCR
