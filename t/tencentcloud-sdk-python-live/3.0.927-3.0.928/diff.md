# Comparing `tmp/tencentcloud-sdk-python-live-3.0.927.tar.gz` & `tmp/tencentcloud-sdk-python-live-3.0.928.tar.gz`
...
## Comparing `tencentcloud-sdk-python-live-3.0.927.tar` & `tencentcloud-sdk-python-live-3.0.928.tar`
...
### Comparing `tencentcloud-sdk-python-live-3.0.927/setup.py` & `tencentcloud-sdk-python-live-3.0.928/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-live-3.0.927/PKG-INFO` & `tencentcloud-sdk-python-live-3.0.928/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-live-3.0.927/tencentcloud_sdk_python_live.egg-info/PKG-INFO` & `tencentcloud-sdk-python-live-3.0.928/tencentcloud_sdk_python_live.egg-info/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-live-3.0.927/README.rst` & `tencentcloud-sdk-python-live-3.0.928/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-live-3.0.927/tencentcloud/live/v20180801/errorcodes.py` & `tencentcloud-sdk-python-live-3.0.928/tencentcloud/live/v20180801/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-live-3.0.927/tencentcloud/live/v20180801/live_client.py` & `tencentcloud-sdk-python-live-3.0.928/tencentcloud/live/v20180801/live_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-live-3.0.927/tencentcloud/__init__.py` & `tencentcloud-sdk-python-live-3.0.928/tencentcloud/__init__.py`
