# Comparing `tmp/msaDocModels-0.0.81.tar.gz` & `tmp/msaDocModels-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "msaDocModels-0.0.81.tar", last modified: Wed Jul  5 17:47:21 2023, max compression
+gzip compressed data, was "msaDocModels-0.0.9.tar", last modified: Fri Nov 25 11:39:48 2022, max compression
```

## Comparing `msaDocModels-0.0.81.tar` & `msaDocModels-0.0.9.tar`

### file list

```diff
@@ -1,24 +1,24 @@
-drwxrwxr-x   0 eduard    (1000) eduard    (1000)        0 2023-07-05 17:47:21.395765 msaDocModels-0.0.81/
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     1099 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/LICENCE
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     3679 2023-07-05 17:47:21.395765 msaDocModels-0.0.81/PKG-INFO
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     2198 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/README.md
-drwxrwxr-x   0 eduard    (1000) eduard    (1000)        0 2023-07-05 17:47:21.395765 msaDocModels-0.0.81/msaDocModels/
--rw-rw-r--   0 eduard    (1000) eduard    (1000)      479 2023-07-05 17:46:13.000000 msaDocModels-0.0.81/msaDocModels/__init__.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)      562 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/msaDocModels/health.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     3763 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/msaDocModels/msg.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)      409 2023-05-29 13:58:15.000000 msaDocModels-0.0.81/msaDocModels/openapi.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     2413 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/msaDocModels/scheduler.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)   154089 2023-07-05 17:44:43.000000 msaDocModels-0.0.81/msaDocModels/sdu.py
-drwxrwxr-x   0 eduard    (1000) eduard    (1000)        0 2023-07-05 17:47:21.395765 msaDocModels-0.0.81/msaDocModels/utils/
--rw-rw-r--   0 eduard    (1000) eduard    (1000)        0 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/msaDocModels/utils/__init__.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     1826 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/msaDocModels/utils/htmlutils.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)    22179 2023-03-17 10:42:12.000000 msaDocModels-0.0.81/msaDocModels/wdc.py
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     2103 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/msaDocModels/wfl.py
-drwxrwxr-x   0 eduard    (1000) eduard    (1000)        0 2023-07-05 17:47:21.395765 msaDocModels-0.0.81/msaDocModels.egg-info/
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     3679 2023-07-05 17:47:21.000000 msaDocModels-0.0.81/msaDocModels.egg-info/PKG-INFO
--rw-rw-r--   0 eduard    (1000) eduard    (1000)      442 2023-07-05 17:47:21.000000 msaDocModels-0.0.81/msaDocModels.egg-info/SOURCES.txt
--rw-rw-r--   0 eduard    (1000) eduard    (1000)        1 2023-07-05 17:47:21.000000 msaDocModels-0.0.81/msaDocModels.egg-info/dependency_links.txt
--rw-rw-r--   0 eduard    (1000) eduard    (1000)       13 2023-07-05 17:47:21.000000 msaDocModels-0.0.81/msaDocModels.egg-info/top_level.txt
--rw-rw-r--   0 eduard    (1000) eduard    (1000)        1 2023-06-22 08:21:29.000000 msaDocModels-0.0.81/msaDocModels.egg-info/zip-safe
--rw-rw-r--   0 eduard    (1000) eduard    (1000)       38 2023-07-05 17:47:21.395765 msaDocModels-0.0.81/setup.cfg
--rw-rw-r--   0 eduard    (1000) eduard    (1000)     2164 2023-03-17 10:04:49.000000 msaDocModels-0.0.81/setup.py
...
### Comparing `msaDocModels-0.0.81/LICENCE` & `msaDocModels-0.0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.81/PKG-INFO` & `msaDocModels-0.0.9/PKG-INFO`
...
```diff
@@ -1,10 +1,10 @@
-Metadata-Version: 2.1 Name: msaDocModels Version: 0.0.81 Summary: msaDocModels
...
### Comparing `msaDocModels-0.0.81/README.md` & `msaDocModels-0.0.9/README.md`
...
### Comparing `msaDocModels-0.0.81/msaDocModels/health.py` & `msaDocModels-0.0.9/msaDocModels/health.py`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.81/msaDocModels/msg.py` & `msaDocModels-0.0.9/msaDocModels/msg.py`
...
### Comparing `msaDocModels-0.0.81/msaDocModels/scheduler.py` & `msaDocModels-0.0.9/msaDocModels/scheduler.py`
...
### Comparing `msaDocModels-0.0.81/msaDocModels/utils/htmlutils.py` & `msaDocModels-0.0.9/msaDocModels/utils/htmlutils.py`
...
### Comparing `msaDocModels-0.0.81/msaDocModels/wdc.py` & `msaDocModels-0.0.9/msaDocModels/wdc.py`
...
### Comparing `msaDocModels-0.0.81/msaDocModels/wfl.py` & `msaDocModels-0.0.9/msaDocModels/wfl.py`
...
### Comparing `msaDocModels-0.0.81/msaDocModels.egg-info/PKG-INFO` & `msaDocModels-0.0.9/msaDocModels.egg-info/PKG-INFO`
