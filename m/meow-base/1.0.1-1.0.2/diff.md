# Comparing `tmp/meow_base-1.0.1.tar.gz` & `tmp/meow_base-1.0.2.tar.gz`
...
## Comparing `meow_base-1.0.1.tar` & `meow_base-1.0.2.tar`
...
### Comparing `meow_base-1.0.1/PKG-INFO` & `meow_base-1.0.2/PKG-INFO`
...
### Comparing `meow_base-1.0.1/README.md` & `meow_base-1.0.2/README.md`

 * *Files identical despite different names*

### Comparing `meow_base-1.0.1/meow_base.egg-info/PKG-INFO` & `meow_base-1.0.2/meow_base.egg-info/PKG-INFO`
...
### Comparing `meow_base-1.0.1/setup.py` & `meow_base-1.0.2/setup.py`
