# Comparing `tmp/orwynn-1.0.0b5.tar.gz` & `tmp/orwynn-1.0.0b6.tar.gz`
...
### Comparing `orwynn-1.0.0b5/orwynn/apiversion/test_main.py` & `orwynn-1.0.0b6/orwynn/apiversion/test_main.py`
...
### Comparing `orwynn-1.0.0b5/orwynn/http/responses.py` & `orwynn-1.0.0b6/orwynn/http/responses.py`
...
### Comparing `orwynn-1.0.0b5/orwynn/log/helpers.py` & `orwynn-1.0.0b6/orwynn/log/helpers.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/log/test_main.py` & `orwynn-1.0.0b6/orwynn/log/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/log/test_middleware.py` & `orwynn-1.0.0b6/orwynn/log/test_middleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/log/test_websocketmiddleware.py` & `orwynn-1.0.0b6/orwynn/log/test_websocketmiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/mapping/mapping.py` & `orwynn-1.0.0b6/orwynn/mapping/mapping.py`
...
### Comparing `orwynn-1.0.0b5/orwynn/mongo/document.py` & `orwynn-1.0.0b6/orwynn/mongo/document/__init__.py`
...
### Comparing `orwynn-1.0.0b5/orwynn/mongo/mongo.py` & `orwynn-1.0.0b6/orwynn/mongo/mongo.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/mongo/test_main.py` & `orwynn-1.0.0b6/orwynn/mongo/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/proxy/boot.py` & `orwynn-1.0.0b6/orwynn/proxy/boot.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/router/errorhandlermanager.py` & `orwynn-1.0.0b6/orwynn/router/errorhandlermanager.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/router/register/controller.py` & `orwynn-1.0.0b6/orwynn/router/register/controller.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/router/register/middleware.py` & `orwynn-1.0.0b6/orwynn/router/register/middleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/router/router.py` & `orwynn-1.0.0b6/orwynn/router/router.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/router/test_globalroute.py` & `orwynn-1.0.0b6/orwynn/router/test_globalroute.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/singleton/singleton.py` & `orwynn-1.0.0b6/orwynn/singleton/singleton.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/sql/config.py` & `orwynn-1.0.0b6/orwynn/sql/config.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/sql/sql.py` & `orwynn-1.0.0b6/orwynn/sql/sql.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/sql/table.py` & `orwynn-1.0.0b6/orwynn/sql/table.py`
...
### Comparing `orwynn-1.0.0b5/orwynn/sql/test_main.py` & `orwynn-1.0.0b6/orwynn/sql/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/testing/__init__.py` & `orwynn-1.0.0b6/orwynn/testing/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/testing/client.py` & `orwynn-1.0.0b6/orwynn/testing/client.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/testing/test_main.py` & `orwynn-1.0.0b6/orwynn/testing/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/testingtools/__init__.py` & `orwynn-1.0.0b6/orwynn/testingtools/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/crypto/__init__.py` & `orwynn-1.0.0b6/orwynn/utils/crypto/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/fmt/__init__.py` & `orwynn-1.0.0b6/orwynn/utils/fmt/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/fmt/test_main.py` & `orwynn-1.0.0b6/orwynn/utils/fmt/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/klass/__init__.py` & `orwynn-1.0.0b6/orwynn/utils/klass/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/klass/test_klass.py` & `orwynn-1.0.0b6/orwynn/utils/klass/test_klass.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/mp/__init__.py` & `orwynn-1.0.0b6/orwynn/utils/mp/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/mp/location.py` & `orwynn-1.0.0b6/orwynn/utils/mp/location.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/mp/test_main.py` & `orwynn-1.0.0b6/orwynn/utils/mp/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/url/__init__.py` & `orwynn-1.0.0b6/orwynn/utils/url/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/url/helpers.py` & `orwynn-1.0.0b6/orwynn/utils/url/helpers.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/url/test_utils.py` & `orwynn-1.0.0b6/orwynn/utils/url/test_utils.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/validation/__init__.py` & `orwynn-1.0.0b6/orwynn/utils/validation/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/validation/errors.py` & `orwynn-1.0.0b6/orwynn/utils/validation/errors.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/utils/yml/__init__.py` & `orwynn-1.0.0b6/orwynn/utils/yml/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/__init__.py` & `orwynn-1.0.0b6/orwynn/websocket/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/constants.py` & `orwynn-1.0.0b6/orwynn/websocket/constants.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/context/id.py` & `orwynn-1.0.0b6/orwynn/websocket/context/id.py`
...
### Comparing `orwynn-1.0.0b5/orwynn/websocket/context/middleware/builtin.py` & `orwynn-1.0.0b6/orwynn/websocket/context/middleware/builtin.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/context/middleware/contextbuiltin.py` & `orwynn-1.0.0b6/orwynn/websocket/context/middleware/contextbuiltin.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/context/test_main.py` & `orwynn-1.0.0b6/orwynn/websocket/context/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/controller/controller.py` & `orwynn-1.0.0b6/orwynn/websocket/controller/controller.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/controller/test_controller.py` & `orwynn-1.0.0b6/orwynn/websocket/controller/test_controller.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/controller/test_globalroute.py` & `orwynn-1.0.0b6/orwynn/websocket/controller/test_globalroute.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/errorhandler/middleware.py` & `orwynn-1.0.0b6/orwynn/websocket/errorhandler/middleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/errorhandler/test_default.py` & `orwynn-1.0.0b6/orwynn/websocket/errorhandler/test_default.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/log/logger.py` & `orwynn-1.0.0b6/orwynn/websocket/log/logger.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/log/middleware.py` & `orwynn-1.0.0b6/orwynn/websocket/log/middleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/middleware/connectionbuiltin.py` & `orwynn-1.0.0b6/orwynn/websocket/middleware/connectionbuiltin.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/middleware/middleware.py` & `orwynn-1.0.0b6/orwynn/websocket/middleware/middleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/middleware/test_main.py` & `orwynn-1.0.0b6/orwynn/websocket/middleware/test_main.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/routing/helpers.py` & `orwynn-1.0.0b6/orwynn/websocket/routing/helpers.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/routing/nextcall.py` & `orwynn-1.0.0b6/orwynn/websocket/routing/nextcall.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/orwynn/websocket/routing/stack.py` & `orwynn-1.0.0b6/orwynn/websocket/routing/stack.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b5/pyproject.toml` & `orwynn-1.0.0b6/pyproject.toml`
...
### Comparing `orwynn-1.0.0b5/PKG-INFO` & `orwynn-1.0.0b6/PKG-INFO`
