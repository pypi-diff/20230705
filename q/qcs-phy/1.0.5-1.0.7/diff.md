# Comparing `tmp/qcs_phy-1.0.5.tar.gz` & `tmp/qcs_phy-1.0.7.tar.gz`
...
+gzip compressed data, was "qcs_phy-1.0.7.tar", last modified: Wed Jul  5 13:11:39 2023, max compression
```

## Comparing `qcs_phy-1.0.5.tar` & `qcs_phy-1.0.7.tar`
...
+drwxrwxrwx   0        0        0        0 2023-07-05 13:11:39.960096 qcs_phy-1.0.7/
+-rw-rw-rw-   0        0        0     1011 2023-07-05 13:11:39.960096 qcs_phy-1.0.7/PKG-INFO
+-rw-rw-rw-   0        0        0        0 2023-05-10 02:21:31.000000 qcs_phy-1.0.7/README.md
+drwxrwxrwx   0        0        0        0 2023-07-05 13:11:39.955109 qcs_phy-1.0.7/qcs_phy/
+-rw-rw-rw-   0        0        0    55776 2023-07-05 13:08:43.000000 qcs_phy-1.0.7/qcs_phy/__init__.py
+drwxrwxrwx   0        0        0        0 2023-07-05 13:11:39.959099 qcs_phy-1.0.7/qcs_phy.egg-info/
+-rw-rw-rw-   0        0        0     1011 2023-07-05 13:11:39.000000 qcs_phy-1.0.7/qcs_phy.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      192 2023-07-05 13:11:39.000000 qcs_phy-1.0.7/qcs_phy.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-07-05 13:11:39.000000 qcs_phy-1.0.7/qcs_phy.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       23 2023-07-05 13:11:39.000000 qcs_phy-1.0.7/qcs_phy.egg-info/requires.txt
+-rw-rw-rw-   0        0        0        8 2023-07-05 13:11:39.000000 qcs_phy-1.0.7/qcs_phy.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2023-07-05 13:11:39.960096 qcs_phy-1.0.7/setup.cfg
+-rw-rw-rw-   0        0        0     1696 2023-07-05 13:11:23.000000 qcs_phy-1.0.7/setup.py
```

### Comparing `qcs_phy-1.0.5/PKG-INFO` & `qcs_phy-1.0.7/PKG-INFO`
...
### Comparing `qcs_phy-1.0.5/qcs_phy/__init__.py` & `qcs_phy-1.0.7/qcs_phy/__init__.py`
...
### Comparing `qcs_phy-1.0.5/qcs_phy.egg-info/PKG-INFO` & `qcs_phy-1.0.7/qcs_phy.egg-info/PKG-INFO`
...
### Comparing `qcs_phy-1.0.5/setup.py` & `qcs_phy-1.0.7/setup.py`
