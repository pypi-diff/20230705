# Comparing `tmp/brkraw-0.3.11.tar.gz` & `tmp/brkraw-0.3.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "brkraw-0.3.11.tar", last modified: Wed Jul  5 21:13:25 2023, max compression
+gzip compressed data, was "brkraw-0.3.8.tar", last modified: Sat Jul  1 20:57:45 2023, max compression
```

## Comparing `brkraw-0.3.11.tar` & `brkraw-0.3.8.tar`

### file list

```diff
@@ -1,39 +1,39 @@
-drwxr-xr-x   0 shlee      (501) staff       (20)        0 2023-07-05 21:13:25.673984 brkraw-0.3.11/
--rw-r--r--   0 shlee      (501) staff       (20)    35149 2022-07-29 18:29:38.000000 brkraw-0.3.11/LICENSE
--rw-r--r--   0 shlee      (501) staff       (20)      534 2023-07-05 21:13:25.673693 brkraw-0.3.11/PKG-INFO
--rw-r--r--   0 shlee      (501) staff       (20)     4587 2023-07-05 21:13:12.000000 brkraw-0.3.11/README.md
-drwxr-xr-x   0 shlee      (501) staff       (20)        0 2023-07-05 21:13:25.660528 brkraw-0.3.11/brkraw/
--rw-r--r--   0 shlee      (501) staff       (20)      133 2023-07-05 21:13:06.000000 brkraw-0.3.11/brkraw/__init__.py
-drwxr-xr-x   0 shlee      (501) staff       (20)        0 2023-07-05 21:13:25.667043 brkraw-0.3.11/brkraw/lib/
--rw-r--r--   0 shlee      (501) staff       (20)       82 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/lib/__init__.py
--rw-r--r--   0 shlee      (501) staff       (20)    28330 2023-07-05 20:09:02.000000 brkraw-0.3.11/brkraw/lib/backup.py
--rw-r--r--   0 shlee      (501) staff       (20)     3978 2023-07-05 20:08:31.000000 brkraw-0.3.11/brkraw/lib/errors.py
--rw-r--r--   0 shlee      (501) staff       (20)    54866 2023-07-05 21:07:42.000000 brkraw-0.3.11/brkraw/lib/loader.py
--rw-r--r--   0 shlee      (501) staff       (20)     7108 2023-07-05 21:07:43.000000 brkraw-0.3.11/brkraw/lib/orient.py
--rw-r--r--   0 shlee      (501) staff       (20)     1622 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/lib/parser.py
--rw-r--r--   0 shlee      (501) staff       (20)    12833 2023-07-05 20:05:46.000000 brkraw-0.3.11/brkraw/lib/pvobj.py
--rw-r--r--   0 shlee      (501) staff       (20)    12647 2023-07-01 20:53:29.000000 brkraw-0.3.11/brkraw/lib/reference.py
--rw-r--r--   0 shlee      (501) staff       (20)    15943 2023-07-05 20:05:28.000000 brkraw-0.3.11/brkraw/lib/utils.py
-drwxr-xr-x   0 shlee      (501) staff       (20)        0 2023-07-05 21:13:25.668343 brkraw-0.3.11/brkraw/scripts/
--rw-r--r--   0 shlee      (501) staff       (20)        0 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/scripts/__init__.py
--rw-r--r--   0 shlee      (501) staff       (20)     4335 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/scripts/brk_backup.py
--rw-r--r--   0 shlee      (501) staff       (20)    37992 2023-07-05 20:27:38.000000 brkraw-0.3.11/brkraw/scripts/brkraw.py
-drwxr-xr-x   0 shlee      (501) staff       (20)        0 2023-07-05 21:13:25.672695 brkraw-0.3.11/brkraw/ui/
--rw-r--r--   0 shlee      (501) staff       (20)        0 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/ui/__init__.py
--rw-r--r--   0 shlee      (501) staff       (20)      419 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/ui/config.py
--rw-r--r--   0 shlee      (501) staff       (20)     8011 2023-06-07 15:37:29.000000 brkraw-0.3.11/brkraw/ui/main_win.py
--rw-r--r--   0 shlee      (501) staff       (20)     7777 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/ui/previewer.py
--rw-r--r--   0 shlee      (501) staff       (20)     3684 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/ui/scan_info.py
--rw-r--r--   0 shlee      (501) staff       (20)     3503 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/ui/scan_list.py
--rw-r--r--   0 shlee      (501) staff       (20)     5467 2022-07-29 18:29:38.000000 brkraw-0.3.11/brkraw/ui/subj_info.py
-drwxr-xr-x   0 shlee      (501) staff       (20)        0 2023-07-05 21:13:25.662313 brkraw-0.3.11/brkraw.egg-info/
--rw-r--r--   0 shlee      (501) staff       (20)      534 2023-07-05 21:13:25.000000 brkraw-0.3.11/brkraw.egg-info/PKG-INFO
--rw-r--r--   0 shlee      (501) staff       (20)      674 2023-07-05 21:13:25.000000 brkraw-0.3.11/brkraw.egg-info/SOURCES.txt
--rw-r--r--   0 shlee      (501) staff       (20)        1 2023-07-05 21:13:25.000000 brkraw-0.3.11/brkraw.egg-info/dependency_links.txt
--rw-r--r--   0 shlee      (501) staff       (20)       98 2023-07-05 21:13:25.000000 brkraw-0.3.11/brkraw.egg-info/entry_points.txt
--rw-r--r--   0 shlee      (501) staff       (20)      128 2023-07-05 21:13:25.000000 brkraw-0.3.11/brkraw.egg-info/requires.txt
--rw-r--r--   0 shlee      (501) staff       (20)       13 2023-07-05 21:13:25.000000 brkraw-0.3.11/brkraw.egg-info/top_level.txt
--rw-r--r--   0 shlee      (501) staff       (20)       38 2023-07-05 21:13:25.674087 brkraw-0.3.11/setup.cfg
--rw-r--r--   0 shlee      (501) staff       (20)     1545 2023-07-01 20:53:36.000000 brkraw-0.3.11/setup.py
-drwxr-xr-x   0 shlee      (501) staff       (20)        0 2023-07-05 21:13:25.673306 brkraw-0.3.11/tests/
--rw-r--r--   0 shlee      (501) staff       (20)        0 2022-07-29 18:29:38.000000 brkraw-0.3.11/tests/__init__.py
...
### Comparing `brkraw-0.3.11/LICENSE` & `brkraw-0.3.8/LICENSE`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/PKG-INFO` & `brkraw-0.3.8/PKG-INFO`
...
### Comparing `brkraw-0.3.11/README.md` & `brkraw-0.3.8/README.md`
...
### Comparing `brkraw-0.3.11/brkraw/lib/backup.py` & `brkraw-0.3.8/brkraw/lib/backup.py`
...
### Comparing `brkraw-0.3.11/brkraw/lib/errors.py` & `brkraw-0.3.8/brkraw/lib/errors.py`
...
### Comparing `brkraw-0.3.11/brkraw/lib/loader.py` & `brkraw-0.3.8/brkraw/lib/loader.py`
...
### Comparing `brkraw-0.3.11/brkraw/lib/orient.py` & `brkraw-0.3.8/brkraw/lib/orient.py`
...
### Comparing `brkraw-0.3.11/brkraw/lib/parser.py` & `brkraw-0.3.8/brkraw/lib/parser.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw/lib/pvobj.py` & `brkraw-0.3.8/brkraw/lib/pvobj.py`
...
### Comparing `brkraw-0.3.11/brkraw/lib/reference.py` & `brkraw-0.3.8/brkraw/lib/reference.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw/lib/utils.py` & `brkraw-0.3.8/brkraw/lib/utils.py`
...
### Comparing `brkraw-0.3.11/brkraw/scripts/brk_backup.py` & `brkraw-0.3.8/brkraw/scripts/brk_backup.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw/scripts/brkraw.py` & `brkraw-0.3.8/brkraw/scripts/brkraw.py`
...
### Comparing `brkraw-0.3.11/brkraw/ui/main_win.py` & `brkraw-0.3.8/brkraw/ui/main_win.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw/ui/previewer.py` & `brkraw-0.3.8/brkraw/ui/previewer.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw/ui/scan_info.py` & `brkraw-0.3.8/brkraw/ui/scan_info.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw/ui/scan_list.py` & `brkraw-0.3.8/brkraw/ui/scan_list.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw/ui/subj_info.py` & `brkraw-0.3.8/brkraw/ui/subj_info.py`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/brkraw.egg-info/PKG-INFO` & `brkraw-0.3.8/brkraw.egg-info/PKG-INFO`
...
### Comparing `brkraw-0.3.11/brkraw.egg-info/SOURCES.txt` & `brkraw-0.3.8/brkraw.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `brkraw-0.3.11/setup.py` & `brkraw-0.3.8/setup.py`
